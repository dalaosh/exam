<template>
  <div class="admin-page admin-page--table">
    <section class="admin-page-head">
      <div>
        <h2 class="admin-page-head__title">学生管理</h2>
        <p class="admin-page-head__desc">统一查看学生账号信息、联系方式和密钥摘要。</p>
      </div>
    ...
    <section class="admin-panel admin-panel--table">
      <div class="admin-panel__head">
        <div>
          <h3 class="admin-panel__title">学生列表</h3>
      ...
      >
        ...
        <el-table-column prop="id" label="学生ID" width="110" align="center" fixed />
