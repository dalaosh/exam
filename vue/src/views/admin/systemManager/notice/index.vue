  ...
  <div class="admin-page admin-page--table">
    <section class="admin-page-head">
      <div>
        ...
        <p class="admin-page-head__desc">维护系统公告内容，支持快速查看、编辑和发布。</p>
      </div>
      <div class="admin-page-head__meta">
        <el-tag class="admin-tag" type="info">共 {{ total }} 条公告</el-tag>
      </div>
    </section>
    ...
    <section class="admin-panel admin-panel--toolbar">
      <div class="admin-toolbar">
        ...
        <div class="admin-toolbar__actions">
          ...
          <el-button type="primary" @click="insert">新增公告</el-button>
        </div>
      </div>
    </section>
    ...
    <section class="admin-panel admin-panel--table">
      <div class="admin-panel__head">
        <div>
          <h3 class="admin-panel__title">公告列表</h3>
          <p class="admin-panel__desc">支持查看详情、编辑公告以及批量管理。</p>
        </div>
      </div>
      ...
      >
        ...
        <el-table-column prop="id" label="公告ID" width="120" align="center" />
        <el-table-column prop="admin.name" label="发布人" width="140" align="center" />
        <el-table-column prop="name" label="公告标题" min-width="260" align="center" />
        <el-table-column prop="content" label="公告内容" width="140" align="center">
...
export default {
  ...
  methods: {
    ...
    deleteBatch() {
      ...
      this.$confirm("您确定批量删除这些公告吗？", "确认删除", { type: "warning" }).then(() => {
