...
<!--    表单-->
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="name" label="新闻标题" width="200" align="center"></el-table-column>
        <el-table-column prop="content" label="新闻内容" width="200" align="center">
...
<!--    富文本显示-->
    <div>
      <el-dialog title="新闻详情" :visible.sync="editorVisible" width="60%">
        <div v-html="this.viewData" class="w-e-text"></div>
      </el-dialog>
    </div>
    <!--    添加弹窗面板-->
    <div>
      <el-dialog title="请填写新闻信息" :visible.sync="dialogFormVisible" width="60%">
        <el-form :model="form">
          <el-form-item label="新闻标题" label-width="10%">
            <el-input v-model="form.name" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="新闻内容" label-width="10%">
