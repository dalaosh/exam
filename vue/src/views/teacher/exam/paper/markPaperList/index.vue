        ...
        <el-col :span="8" v-for="(item, index) in tableData" :key="index">
          <el-card class="card cardMsg" :body-style="{ padding: '0px' }">
            ...
            <div style="padding: 0 2% 0 2%;text-align: center;">
              <el-button type="text" @click="showPublicKeys(item.id)" size="small" style="color: #009dff;font-size: 20px;margin-right: 3%">查看环公钥</el-button>
              <el-button type="text" @click="showManager(item)" size="small" style="color: #009dff;font-size: 20px">查看详情</el-button>
              <el-button type="text" @click="beginExam(item.id)" size="small" style="color: #009dff;font-size: 20px">进入阅卷</el-button>
            </div>
          </el-card>
        </el-col>
      </el-row>
