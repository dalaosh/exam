      ...
      <div style="margin: 2vh 8% 2vh 8%" v-for="(data, index) in questions" :key="index" >
        <el-card shadow="hover" class="box-card cards">
          ...
          <div style="font-size: 18px;margin-bottom: 2vh">
                {{index+1}}、{{data.questionCode.question}}
          </div>
      ...
      <div class="main">
        ...
        <div class="search">
          <el-row style="margin-top: 2vh;margin-left: 2%">
            <el-form :inline="true" :model="findQuestionCodeParams" class="demo-form-inline">
              <el-form-item label="题目编号:" style="padding-right: 2%">
                <el-input clearable v-model="findQuestionCodeParams.id" placeholder="题目编号"></el-input>
              </el-form-item>
              <el-form-item label="章节:" style="padding-right: 2%">
                <el-input  clearable v-model="findQuestionCodeParams.section" placeholder="章节"></el-input>
              </el-form-item>
              <el-form-item label="分值:" style="padding-right: 6%">
                <el-input clearable  clearable v-model="findQuestionCodeParams.score" placeholder="分值"></el-input>
              </el-form-item>
              <el-form-item label="难度等级:" style="padding-right: 2%">
                <el-input clearable v-model="findQuestionCodeParams.level" placeholder="难度等级"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="findQuestionCode">查询</el-button>
              </el-form-item>
            </el-form>
          </el-row>
        </div>
...
export default {
  ...
  methods: {
    ...
    findQuestionCode(){
      request.get('/exam/questionCode/selectAll', {
        params:this.findQuestionCodeParams
      }).then(res => {
        if (res.code === '200') {
