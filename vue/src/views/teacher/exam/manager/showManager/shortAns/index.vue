        ...
        <el-card shadow="hover" class="box-card cards">
          ...
          <div style="font-size: 18px;margin-bottom: 2vh">
            <el-row>
              ...
              <el-col :span="22">
                <div v-html="data.questionShortAns.question" class="w-e-text"></div>
              </el-col>
            </el-row>
          </div>
          <div style="font-size: 18px;margin-bottom: 2vh">
            <el-row>
              <el-col :span="2" >
                <div style="text-align: center" v-html="'<p>答：'+'</p>'" class="w-e-text"></div>
              </el-col>
              <el-col :span="22">
                <div v-html="data.questionShortAns.answer" class="w-e-text"></div>
              </el-col>
            </el-row>
          </div>
          <div style="font-size: 18px;margin-bottom: 2vh">
            <el-row>
              <el-col :span="2" >
                <div v-html="'<p>'+'解析:'+'</p>'" class="w-e-text"></div>
              </el-col>
              <el-col :span="22">
                <div v-html="data.questionShortAns.analysis" class="w-e-text"></div>
              </el-col>
            </el-row>
      ...
      <div class="main">
        ...
        <div class="search">
          <el-row style="margin-top: 2vh;margin-left: 2%">
            <el-form :inline="true" :model="findQuestionShortAnsParams" class="demo-form-inline">
              <el-form-item label="题目编号:" style="padding-right: 2%">
                <el-input clearable v-model="findQuestionShortAnsParams.id" placeholder="题目编号"></el-input>
              </el-form-item>
              <el-form-item label="章节:" style="padding-right: 2%">
                <el-input  clearable v-model="findQuestionShortAnsParams.section" placeholder="章节"></el-input>
              </el-form-item>
              <el-form-item label="分值:" style="padding-right: 6%">
                <el-input clearable  clearable v-model="findQuestionShortAnsParams.score" placeholder="分值"></el-input>
              </el-form-item>
              <el-form-item label="难度等级:" style="padding-right: 2%">
                <el-input clearable v-model="findQuestionShortAnsParams.level" placeholder="难度等级"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="findQuestionShortAns">查询</el-button>
              </el-form-item>
            </el-form>
          </el-row>
        </div>
...
export default {
  ...
  created() {
    ...
    this.findQuestionShortAnsParams={
  ...
  methods: {
    ...
    findQuestionShortAns(){
      request.get('/exam/questionShortAns/selectAll', {
        params:this.findQuestionShortAnsParams
      }).then(res => {
        if (res.code === '200') {
