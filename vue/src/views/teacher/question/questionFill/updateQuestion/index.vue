<template>
  <div class="teacher-page teacher-question-editor">
    <section class="teacher-page-head">
      <div>
        <h2 class="teacher-page-head__title">编辑填空题</h2>
        <p class="teacher-page-head__desc">统一题面、答案和解析布局，让题库编辑页的容器比例与间距更稳定。</p>
      </div>
    </section>
    ...
    <div class="teacher-question-editor__two-col">
      <div class="teacher-question-editor__stack">
        <section class="teacher-panel teacher-panel--padded">
          ...
          <div class="w-e-text-container" id="editorA" style="width: 100%; height: 320px; z-index: 2"></div>
        </section>
