...
.teacher-code-editor-page .teacher-question-editor__two-col:last-of-type {
  align-items: stretch;
}

.teacher-code-editor-page .teacher-question-editor__two-col:last-of-type .teacher-question-editor__stack:last-child {
  min-height: 0;
}

.teacher-code-editor-page .teacher-question-editor__actions {
  padding: 16px 0 0;
  margin-top: 0;
}
