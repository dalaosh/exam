<template>
  <div class="teacher-page teacher-question-list-page">
    <section class="teacher-page-head">
      <div>
        <h2 class="teacher-page-head__title">编程题列表</h2>
        <p class="teacher-page-head__desc">统一查询区、批量操作区、表格卡片和分页区域的布局节奏。</p>
      </div>
    </section>
      ...
      <div class="teacher-question-list-page__toolbar-row">
        <el-form :model="params" class="demo-form-inline teacher-question-list-page__filters">
          ...
          <el-form-item label="章节:">
            <el-input clearable v-model="params.section" placeholder="章节" />
          </el-form-item>
        ...
        <div class="teacher-question-list-page__actions">
          ...
          <el-upload
            action="http://localhost:9998/exam/questionCode/upload"
    ...
    <section class="teacher-panel teacher-question-list-page__table-card">
      ...
      >
        ...
        <el-table-column prop="course.id" label="课程ID" width="100" align="center" />
        <el-table-column label="课程信息" align="center">
          ...
          <el-table-column prop="course.name" label="课程名称" width="200" align="center" fixed />
          <el-table-column prop="course.number" label="课程编号" width="150" align="center" />
        </el-table-column>

        <el-table-column prop="teacher.id" label="出题人ID" width="100" align="center" />
        <el-table-column label="出题人信息" align="center">
          <el-table-column prop="teacher.name" label="姓名" width="100" align="center" />
          ...
          <el-table-column prop="teacher.role" label="角色" width="100" align="center" />
          <el-table-column prop="teacher.sex" label="性别" width="100" align="center" />
          <el-table-column prop="teacher.email" label="电子邮箱" width="200" align="center" />
          <el-table-column prop="teacher.phone" label="电话" width="200" align="center" />
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      request
        .get("/exam/questionCode/selectPage", {
          params: this.params,
        })
        .then((res) => {
          if (res.code === "200") {
