      ...
      <el-col :span="8">
        ...
        <el-row>
          <div class="left-bottom">
            ...
            <el-row style="margin-bottom: 3vh;margin-top: 1vh">
              <el-col :span="8">
                课程名称:
              </el-col>
              <el-col :span="16">
      ...
      <el-col :span="16">
        <el-row>
          <div class="right">
            ...
            <div class="question">
              <div v-html="this.table.question" style="margin-bottom: 2vh" class="w-e-text"></div>
              <div style="margin-bottom: 1vh">
                <strong>A</strong> 、{{this.table.answerA}}
              </div>
              <div style="margin-bottom: 1vh">
                <strong>B</strong> 、{{this.table.answerB}}
              </div>
              <div style="margin-bottom: 1vh">
                <strong>C</strong> 、{{this.table.answerC}}
              </div>
              <div style="margin-bottom: 1vh">
                <strong>D</strong> 、{{this.table.answerD}}
              </div>
            </div>
            <div style="font-size: 26px;;margin-top: 2vh;margin-bottom: 1vh">
              答案：
