          ...
          <div class="questions">
            <el-card class="box-card questionBody">
              ...
              <div v-if="this.currentQuestionType==='multi'">
                ...
                <div>
                  <el-row>
                    <el-col :span="6" style="margin-top: 2vh">
                      你的答案：{{answer}}
                    </el-col>
                    <el-col :span="12">
                      <el-checkbox-group
                    ...
                    <el-col :span="6">
                      <el-button type="primary" plain style="width: 50%;font-size: 24px;" @click="submit">确 定</el-button>
                    </el-col>
                  </el-row>
                  <hr>
                </div>
                ...
                <div>
                  <el-row>
                    ...
                    <el-col :span="12"  style="margin-top: 1vh">
                      <template>
                        <el-radio v-model="answer" label="T"><a style="font-size: 28px">T</a></el-radio>
                        <el-radio v-model="answer" label="F"><a style="font-size: 28px">F</a></el-radio>
                      </template>
                    </el-col>
                    <el-col :span="6">
                      <el-button type="primary" plain style="width: 50%;font-size: 24px;" @click="submit">确 定</el-button>
              ...
              <div v-if="this.currentQuestionType==='shortAns'">
                ...
                <div>
                  <el-row>
                    ...
                    <el-col :span="16">
                      <div class="w-e-text-container" id='editorA' style="width: 98%;height: 50vh"></div>
                    </el-col>
                    <el-col :span="4">
                      <el-button type="primary" plain style="width: 50%;font-size: 24px;" @click="submit">确 定</el-button>
                    </el-col>
            ...
            <el-card class="box-card questionBottom">
              <el-row>
                ...
                <el-col :span="12" style="text-align: center">
                  <el-button v-if="question.isMarked==='否'" type="primary" round style="width: 50%;margin-top:3vh;font-size: 24px;" @click="markQuestion('是')">标  记</el-button>
                  <el-button v-if="question.isMarked==='是'" type="primary" round style="width: 50%;margin-top:3vh;font-size: 24px;" @click="markQuestion('否')">取 消 标  记</el-button>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    submit(){
      const answer = this.questionAnswer.find(ans => ans.paperId === this.question.paperId);
      if(this.currentQuestionType==='shortAns'){
