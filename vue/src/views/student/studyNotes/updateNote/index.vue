<template>
  <div class="mains">
    <div style="height:10vh;padding-top: 3vh;padding-left: 2%;background: #f4f5f6">
      <el-row>
        <el-col :span="6" style="font-size: 16px;text-align: center">
        ...
        <el-row :span="6">
          <div style="text-align: center">
            <el-button type="primary" @click="update" plain style="text-align: center">更改上传</el-button>
          </div>
        </el-row>
      </el-row>
    </div>
...
export default {
  ...
  methods:{
    ...
    update(){
      ...
      request.put("/md/update",form).then(res=>{
        if(res.code==="200"){
