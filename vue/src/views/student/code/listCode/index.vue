  ...
  <div class="main">
    ...
    <div class="search">
      <el-row style="margin-top: 2vh;margin-left: 2%">
        ...
        <el-form :inline="true" :model="params" class="demo-form-inline">
          <el-form-item label="问题:" style="padding-right: 4%">
            <el-input v-model="params.title" placeholder="问题"></el-input>
          </el-form-item>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="title" label="题目" width="400" align="center">
