  ...
  <div class="main">
      ...
      <el-row style="margin-top: 2vh;margin-left: 2%">
        <el-form :inline="true" :model="params" class="demo-form-inline">
          ...
          <el-form-item label="学校名称:" style="padding-right: 4%">
            <el-select v-model="params.schoolsId" clearable filterable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="学院名称:" style="padding-right: 4%">
            <el-input v-model="params.collegesName" placeholder="学院名称"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="id" label="学院id" width="80" align="center"></el-table-column>
        <el-table-column prop="collegesName" label="学院名称" width="200" align="center"></el-table-column>
        <el-table-column prop="universityId" label="学校id" width="80" align="center"></el-table-column>
        <el-table-column prop="schoolsUniversity.universityName" label="学校名称" width="200" align="center"></el-table-column>
      ...
      <el-dialog title="请填写信息" :visible.sync="dialogFormVisible" width="40%">
        <el-form :model="form">
          <el-form-item label="学校名称" label-width="15%">
            <el-select style="width: 85%" v-model="form.universityId" clearable filterable placeholder="请选择">
              <el-option
                  v-for="item in university"
                  :key="item.id"
                  :label="item.universityName"
          ...
          <el-form-item label="学院名称" label-width="15%">
            <el-input v-model="form.collegesName" autocomplete="off" style="width: 85%"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    load(){
      ...
      request.get('/trustSeal/universityCollegeMajor/college/selectPage', {
        params:this.params
      }).then(res => {
        if (res.code === '200') {
    ...
    deleteById(id){
      this.$confirm('您确定删除吗？', '确认删除', {type: "warning"}).then(response => {
        request.delete('/trustSeal/universityCollegeMajor/college/delete/' + id).then(res => {
    ...
    deleteBatch(){
      ...
      this.$confirm('您确定批量删除这些数据吗？', '确认删除', {type: "warning"}).then(response => {
        request.delete('/trustSeal/universityCollegeMajor/college/delete/batch', {data: this.ids}).then(res => {
          if (res.code === '200') {   // 表示操作成功
    ...
    submit() {
      request({
        url: this.form.id ? '/trustSeal/universityCollegeMajor/college/update' : '/trustSeal/universityCollegeMajor/college/add',
