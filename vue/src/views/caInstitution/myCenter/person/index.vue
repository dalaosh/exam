...
export default {
  ...
  methods: {
    load(){
      request.get("user/caInstitution/selectById/"+this.user.id).then(res=>{
        if(res.code==="200"){
    ...
    handleAvatarSuccess(res){
      ...
      request.put("/user/caInstitution/update/inform",table).then(res=>{
        if(res.code==="200"){
    ...
    update(){
      ...
      request.put("/user/caInstitution/update/inform",this.form).then(res=>{
        if(res.code==="200"){
