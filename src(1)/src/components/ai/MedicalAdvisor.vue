    ...
    >
      <div class="advisor-container">
        ...
        <div class="advisor-header">
          <div class="title">
            <img src="@/assets/imgs/AI.png" alt="智能医疗顾问" class="advisor-avatar">
            <h3>智能医疗助手</h3>
          </div>
        </div>
        ...
        <div class="chat-container" ref="chatContainer">
          ...
          >
            <div v-if="message.sender === 'bot'" class="avatar">
              <img src="@/assets/imgs/AI.png" alt="智能助手">
            </div>
  ...
  watch: {
    visible(newVal) {
      ...
      if (newVal && this.chatMessages.length === 0) {
        // 第一次打开时发送欢迎消息
        this.addBotMessage("您好，我是智能医疗助手，请问您遇到什么医疗问题了吗？");
      }
    },
  ...
  methods: {
    ...
    clearChat() {
      this.$confirm('确定要清空所有对话记录吗?', '提示', {
        ...
        this.messages.push({
          role: 'assistant',
          content: "您好，我是智能医疗助手，请问您遇到什么医疗问题了吗？"
        });
      }).catch(() => {});
    },
