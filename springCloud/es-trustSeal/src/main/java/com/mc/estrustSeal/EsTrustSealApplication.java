...
public class EsTrustSealApplication {

    public static void main(String[] args) {
        ConfigurableEnvironment env = SpringApplication.run(EsTrustSealApplication.class, args).getEnvironment();
