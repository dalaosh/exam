 ...
 */
@RestController
@RequestMapping("/files/avatar")
@Tag(name = "头像接口",description = "关于头像的相关操作")
public class AvatarFileController {

    // 文件上传存储路径
    private static final String filePath = System.getProperty("user.dir") + "/files/avatar/";
    ...
    public Result upload(MultipartFile file) {
        String flag;
        synchronized (AvatarFileController.class) {
        ...
        String http = "http://" + ip + ":" + port + "/files/avatar/";
