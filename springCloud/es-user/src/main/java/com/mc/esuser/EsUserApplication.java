...
@MapperScan("com.mc.esuser.mapper")
public class EsUserApplication {

    public static void main(String[] args) {
        ConfigurableEnvironment env = SpringApplication.run(EsUserApplication.class, args).getEnvironment();
